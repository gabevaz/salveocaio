        ...
        <header class="flex justify-between py-12 items-center">
            ...
            <nav class="flex justify-end flex-col md:flex-row">
                ...
                <ul
                    ...
                    <li class="uppercase hover:text-theme-secondary transition duration-200"><a href="#history"
                            v-smooth-scroll>História</a></li>
                    <li class="uppercase hover:text-theme-secondary transition duration-200"><a href="#hope"
                            v-smooth-scroll>Nossa esperança</a></li>
                    <li class="uppercase hover:text-theme-secondary transition duration-200"><a href="#features"
                            v-smooth-scroll>O que é CLN7</a></li>
                    <li class="uppercase hover:text-theme-secondary transition duration-200"><a href="#contact"
                            v-smooth-scroll>Contato</a></li>
                    <li class="uppercase hover:text-theme-secondary transition duration-200"><a href="#gallery"
                            v-smooth-scroll>Fotos</a></li>
                    <li
                        ...
                        <a href="#como-ajudar" v-smooth-scroll>Como ajudar</a>
                    </li>
                </ul>
            </nav>
        </header>
            ...
            <div
                ...
                <ul class="uppercase text-white text-md tracking-widest items-center flex flex-col mt-14">
                    <li
                        ...
                        <a @click="toggleMobileNav()" href="#history">História</a>
                    </li>
                    <li
                        class="hover:text-theme-secondary transition duration-200 py-4 border-b border-theme-grayish-blue w-full text-center">
                        <a @click="toggleMobileNav()" href="#hope">Nossa esperança</a>
                    </li>
                    <li
                        class="hover:text-theme-secondary transition duration-200 py-4 border-b border-theme-grayish-blue w-full text-center">
                        <a @click="toggleMobileNav()" href="#features">O que é CLN7</a>
                    </li>
                    <li
                        class="hover:text-theme-secondary transition duration-200 py-4 border-b border-theme-grayish-blue w-full text-center">
                    ...
                    <li
                        class="hover:text-theme-secondary transition duration-200 py-4 border-b border-theme-grayish-blue w-full text-center">
                        <a @click="toggleMobileNav()" href="#gallery">Fotos</a>
                    </li>
                    <li
                        ...
                        <a @click="toggleMobileNav()" href="#como-ajudar">Como ajudar</a>
                    </li>
                </ul>
